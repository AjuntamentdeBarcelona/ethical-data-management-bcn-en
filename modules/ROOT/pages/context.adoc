...
This factor, along with an ever-increasing availability of data for measuring practically every aspect of people’s lives (the so-called *big data*), could threaten the levels of freedom enjoyed by the citizens who live in our societies.
